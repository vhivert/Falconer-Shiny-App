###################################################################################
#
# FALCONER SHINY APP - README modal content
#
# readme_content() returns the HTML shown in the README dialog (app.R).
#
###################################################################################

readme_content <- function() {

  genotype_table <- htmlTable(
    matrix(data = c(
      "<b>-<i>a</i><sub>A</sub>-<i>a</i><sub>B</sub>+<i>a</i><sub>AB</sub></b><br>&nbsp;&nbsp;&nbsp;(1-<i>p</i>)<sup>2</sup>(1-<i>q</i>)<sup>2</sup>&nbsp;&nbsp;&nbsp;",
      "<b>-<i>a</i><sub>B</sub></b><br>2<i>p</i>(1-<i>p</i>)(1-<i>q</i>)<sup>2</sup>",
      "<b><i>a</i><sub>A</sub>-<i>a</i><sub>B</sub>-<i>a</i><sub>AB</sub></b><br><i>p</i><sup>2</sup>(1-<i>q</i>)<sup>2</sup>",
      "<b>-<i>a</i><sub>A</sub></b><br>(1-<i>p</i>)<sup>2</sup>2<i>q</i>(1-<i>q</i>)",
      "<b>0</b><br>4<i>p</i>(1-<i>p</i>)<i>q</i>(1-<i>q</i>)",
      "<b><i>a</i><sub>A</sub></b><br>2<i>p</i><sup>2</sup><i>q</i>(1-<i>q</i>)",
      "<b>-<i>a</i><sub>A</sub>+<i>a</i><sub>B</sub>-<i>a</i><sub>AB</sub></b><br>(1-<i>p</i>)<sup>2</sup><i>q</i><sup>2</sup>",
      "<b><i>a</i><sub>B</sub></b><br>2<i>p</i>(1-<i>p</i>)<i>q</i><sup>2</sup>",
      "<b><i>a</i><sub>A</sub>+<i>a</i><sub>B</sub>+<i>a</i><sub>AB</sub></b><br><i>p</i><sup>2</sup><i>q</i><sup>2</sup>"),
  ...
  HTML("<h1>Welcome to the Falconer ShinyApp</h1><br><br>
...
with <i>H</i> the heterozygosity at the locus. Note that <i>V<sub>A</sub></i> is the variance explained by a SNP in GWAS (2<i>p</i>(1-<i>p</i>)&#120572;<sup>2</sup> = 2<i>p</i>(1-<i>p</i>)&beta;<sup>2</sup>) and contains both a term due to additivity (<i>a</i>) and dominance (<i>d</i>) through the average effect &#120572;.<br><br>
...
We extend the one-locus to a two-locus model with additive and additive-by-additive epistatic interaction only, assuming no within loci dominance effects (<i>d</i> = 0 at both loci). We introduce a second (unlinked) locus with alleles B<sub>1</sub> and B<sub>2</sub> in frequencies <i>q</i> and 1-<i>q</i> respectively. The genotypic values and frequencies of the 9 genotypes are:<br>",

  genotype_table,

  "where <i>a</i><sub>A</sub> (<i>a</i><sub>B</sub>) is the genotypic value for the upper homozygote A<sub>1</sub>A<sub>1</sub> (B<sub>1</sub>B<sub>1</sub>) and <i>a</i><sub>AB</sub> is the additive-by-additive interaction effect. This is a re-parametrization of the model described by M&auml;ki-Tanila and Hill (2014).<br><br>
...
&#120572;<sub>A</sub> = <i>a</i><sub>A</sub> + (2<i>q</i>-1)<i>a</i><sub>AB</sub><br>

&#120572;<sub>B</sub> = <i>a</i><sub>B</sub> + (2<i>p</i>-1)<i>a</i><sub>AB</sub><br><br>
...
<i>V<sub>A</sub></i> = 2<i>p</i>(1-<i>p</i>)[<i>a</i><sub>A</sub>+(2<i>q</i>-1)<i>a</i><sub>AB</sub>]<sup>2</sup> + 2<i>q</i>(1-<i>q</i>)[<i>a</i><sub>B</sub>+(2<i>p</i>-1)<i>a</i><sub>AB</sub>]<sup>2</sup> <br><br>

Note that <i>V<sub>A</sub></i> contains a term due to the pairwise additive-by-additive interaction between locus A and B (<i>a</i><sub>AB</sub>).<br><br>
...
<i>V<sub>AA</sub></i> = 4<i>p</i>(1-<i>p</i>)<i>q</i>(1-<i>q</i>)<i>a</i><sub>AB</sub><sup>2</sup><br><br>
